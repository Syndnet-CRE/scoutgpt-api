...
const tools = [
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        propertyType: { type: 'string', description: 'ATTOM numeric property code(s). Can be comma-separated for multiple types. Key codes: "369"=Apartment, "167"=Office, "169"=Retail, "238"=Warehouse/Industrial, "401"=Vacant Land, "160"=Hotel, "339"=Self-Storage, "148"=Medical Office, "373"=Duplex, "378"=Triplex/Quad, "139"=Small Retail/NNN. Do NOT pass text labels.' },
